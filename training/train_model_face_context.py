...
class TrainRTGENE(pl.LightningModule):
    ...
    def forward(self, left_patch, right_patch, face_patch):
        return self.model(left_patch, right_patch, face_patch)

    def shared_step(self, batch):
        _, _, _, left_patch, right_patch, face_patch, _, gaze_labels = batch

        angle_out = self.forward(left_patch, right_patch, face_patch)
